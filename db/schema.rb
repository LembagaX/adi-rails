...
ActiveRecord::Schema.define(version: 2019_02_21_140937) do
  ...
  create_table "advertises_catalogs", id: false, force: :cascade do |t|
  ...
  create_table "sales_invoices", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.date "due"
    t.index ["order_id"], name: "index_sales_invoices_on_order_id"
  end
  ...
  add_foreign_key "sales_invoices", "orders"
