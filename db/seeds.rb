...
chain   = Product.create! code: 'LB11', name: 'Chain Lube A72', serial_number: '1112222111', price: 0, category: lube
spray   = Product.create! code: 'PT12', name: 'Red Spray Paint', serial_number: '1113333111', price: 0, category: paint
